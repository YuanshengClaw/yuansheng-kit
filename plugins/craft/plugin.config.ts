...
export default {
  ...
  resources: {
    ...
    "craft-store-index": {
      ...
      requires: ["craft-store-action-journal", "craft-store-runtime", "craft-store-records"],
    },
    "craft-store-action-journal": {
      kind: "workflow",
      logicalPath: "workflows/store/action-journal.ts",
      source: {
        kind: "file",
        path: "plugins/craft/workflows/store/action-journal.ts",
      },
      requires: [
        "craft-contract-canonical",
        "craft-contract-generated-index",
    ...
    "opencode-adapter-runtime": {
      kind: "platform-runtime",
      logicalPath: "opencode/src/adapter-runtime.ts",
      source: {
        kind: "file",
        path: "plugins/craft/opencode/src/adapter-runtime.ts",
      },
      requires: [
        "craft-blueprint-import-transaction",
        "craft-blueprint-import-verifier",
    ...
    "opencode-platform-principal": {
      kind: "platform-runtime",
      logicalPath: "opencode/src/platform-principal.ts",
      source: {
        kind: "file",
        path: "plugins/craft/opencode/src/platform-principal.ts",
      },
      requires: ["craft-state-machine-principal"],
    },
